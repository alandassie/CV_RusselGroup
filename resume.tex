...
\geometry{left=1.6cm, top=1.2cm, right=1.6cm, bottom=1.8cm, footskip=.5cm}
...
\address{Rosario Institute of Physics, 27 de Febrero 210Bis, Rosario, Argentina}

\mobile{+54 341 5159190}
\email{dassiealan@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/alandassie}
% \linkedin{linkedin.com/in/alan-cruz-dassie-6ab657111}
% \gitlab{gitlab-id}
